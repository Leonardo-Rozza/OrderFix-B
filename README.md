...
> - **`docs/plans/2026-09-05-legal-public-requirements-read-closure.md`** — cierre de requisitos públicos:
>   DTO completo, ETag agregado, revalidación íntegra, concurrencia, capacidad y tiempos límite
>   sobre PostgreSQL restringido, con gate integral fresco en 14E.
>   `ordenfix.legal.public-requirements.enabled` sigue apagado; el handoff global continúa cerrado.
