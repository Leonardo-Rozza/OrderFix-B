...
@RestControllerAdvice(assignableTypes = LegalPrivateRequirementsController.class)
@Order(Ordered.HIGHEST_PRECEDENCE)
@Conditional(LegalPrivateRequirementsHttpConfiguration.Enabled.class)
public final class LegalPrivateRequirementsExceptionHandler {

    @ExceptionHandler(LegalPrivateRequirementsHttpException.class)
    public ResponseEntity<ApiError> handle(LegalPrivateRequirementsHttpException exception,
    ...
    public ResponseEntity<ApiError> forbidden(AccessDeniedException exception,
                                             HttpServletRequest request, HttpServletResponse response) {
        return handle(LegalPrivateRequirementsHttpException.forbidden(exception), request, response);
    }
}
