...
/**
 * Verifies the isolated private-requirements consumer's exact effective PostgreSQL capabilities.
 *
 * <p>A consumer-owned allowlist: actor columns and immutable evidence are readable, while only
 * aggregate materialization is writable. Historical public/editorial roles remain unchanged.
 * V29 schema accreditation is a separate mandatory preflight of the private gate.</p>
 */
final class LegalPrivateRequirementsPrivilegeVerifier implements LegalDatabasePreflight {
    ...
    LegalPrivateRequirementsPrivilegeVerifier(
            JdbcTemplate jdbc,
            String expectedRole,
