...
/**
 * Verifies the isolated public-requirements consumer's exact effective PostgreSQL capabilities.
 *
 * <p>Intentionally scoped from the V28 mutable verifier, without widening that role or the public
 * document reader. The frozen V28 inventory is reused only for schema dependencies and topology.</p>
 */
final class LegalPublicRequirementsPrivilegeVerifier implements LegalDatabasePreflight {
    ...
    static final Set<String> INSERT_TABLES = Set.of(
            "legal_requisito_agregados",
            "legal_requisito_agregado_scopes");
    // Required for V28's FOR SHARE; the frozen V27 trigger denies actual and no-op UPDATE.
    ...
    LegalPublicRequirementsPrivilegeVerifier(
            JdbcTemplate jdbc,
            String expectedRole,
