...
/**
 * Verifies the isolated authenticated-acceptance consumer's exact effective PostgreSQL capabilities.
 *
 * <p>A consumer-owned allowlist: actor columns and immutable evidence are readable, and aggregate, evidence, metadata and idempotent results are append-only writable. Historical public/editorial roles remain unchanged.
 * V29 schema accreditation is a separate mandatory preflight of the acceptance boundary.</p>
 */
final class LegalAcceptancePrivilegeVerifier implements LegalDatabasePreflight {
    ...
    LegalAcceptancePrivilegeVerifier(
            JdbcTemplate jdbc,
            String expectedRole,
