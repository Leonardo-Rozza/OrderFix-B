...
/** Verifies the isolated V28 aggregate role's exact effective PostgreSQL capabilities. */
final class LegalV28AggregatePrivilegeVerifier implements LegalDatabasePreflight {
    ...
    static final Set<String> READ_TABLES = LegalV28AggregateInventory.EDITORIAL_TABLES;
    static final Set<String> INSERT_TABLES = LegalV28AggregateInventory.INSERT_TABLES;
    static final Set<String> PRIVILEGED_FUNCTIONS =
            LegalV28AggregateInventory.PRIVILEGED_FUNCTIONS;
    ...
    LegalV28AggregatePrivilegeVerifier(
            JdbcTemplate jdbc,
            String expectedRole,
    ...
    private void verifyRelationsAndColumns(long roleOid) {
        ...
        expectedRelations.add(LegalV28AggregateInventory.FLYWAY_HISTORY_TABLE);
        ...
        for (ColumnState column : columns) {
            ...
            boolean allowedUpdate = targetSchema
                    && LegalV28AggregateInventory.UPDATE_COLUMNS
    ...
    private void verifySequences(long roleOid) {
        ...
        if (!found.equals(LegalV28AggregateInventory.WRITABLE_SEQUENCES)) {
            incompatible();
        }
    }
    ...
    private void verifyFunctions(long roleOid) {
        ...
        for (FunctionPrivilege function : functions) {
            ...
            if (function.owner()
                    ...
                    || function.executeGrant()
                    || ((v28 || allowed) && function.publicExecute())) {
                incompatible();
            }
        }
