...
class LegalV33SchemaSnapshot {
    @Test
    void captureCleanClosureCatalogs() throws Exception {
        try (var postgres = new PostgreSQLContainer("postgres:16-alpine")
                .withDatabaseName("ordenfix_v33_schema_snapshot")
            ...
            System.out.println("V33_LEGAL_CATALOG=" + legal.catalog());
            System.out.println("V33_HISTORY=" + legal.flyway());
            System.out.println("V33_CLOSURE_DELTA=" + LegalV33ClosureSchema.snapshot(jdbc));
            ...
            System.out.println("V33_REGISTRATION_CATALOG=" + registration.invoke(new LegalRegistrationSchemaVerifier(jdbc, "public")));
            ...
            System.out.println("V33_PHOTO_CATALOG=" + HexFormat.of().formatHex(MessageDigest.getInstance("SHA-256")
