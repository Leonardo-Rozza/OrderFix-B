...
class LegalV34SchemaSnapshot {
    @Test
    void captureCleanClosureCatalogs() throws Exception {
        try (var postgres = new PostgreSQLContainer("postgres:16-alpine")
                .withDatabaseName("ordenfix_v34_schema_snapshot")
            ...
            System.out.println("V34_LEGAL_CATALOG=" + legal.catalog());
            System.out.println("V34_HISTORY=" + legal.flyway());
            System.out.println("V34_BASE_CLOSURE_DELTA=" + LegalV33ClosureSchema.snapshot(jdbc));
            System.out.println("V34_CONFIRMED_CLOSURE_DELTA=" + LegalV34ClosureSchema.snapshot(jdbc));
            ...
            System.out.println("V34_REGISTRATION_CATALOG=" + registration.invoke(new LegalRegistrationSchemaVerifier(jdbc, "public")));
            ...
            System.out.println("V34_PHOTO_CATALOG=" + HexFormat.of().formatHex(MessageDigest.getInstance("SHA-256")
